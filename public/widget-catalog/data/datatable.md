...
![](/widget-catalog/data/images/DataTable-stamped.png)
...
We used two [File](/widget-catalog/data/../data/file) widgets to read the *Iris* and *Glass* dataset (provided in Orange distribution), and send them to the **Data Table** widget.

![](/widget-catalog/data/images/DataTable-Schema.png)
...
![](/widget-catalog/data/images/DataTable-Example.png)
