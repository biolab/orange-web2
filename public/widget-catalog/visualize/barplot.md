...
![](/widget-catalog/visualize/images/Bar-Plot-stamped.png)
...
The **Bar Plot** widget is most commonly used immediately after the [File](/widget-catalog/visualize/../data/file) widget to compare categorical values. In this example, we have used *heart-disease* data to inspect our variables.

![](/widget-catalog/visualize/images/Bar-Plot-Example.png)
...
Then, we selected patients over 60 years of age with [Select Rows](/widget-catalog/visualize/../data/selectrows). We sent the subset to **Bar Plot** to highlight these patients in the widget. The big outlier with a high cholesterol level is apparently over 60 years old.
