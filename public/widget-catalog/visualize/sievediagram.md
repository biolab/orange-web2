...
![](/widget-catalog/visualize/images/SieveDiagram-stamped.png)
...
![](/widget-catalog/visualize/images/SieveDiagram-Titanic.png)
...
![](/widget-catalog/visualize/images/SieveDiagram-Titanic-age-survived.png)
...
![](/widget-catalog/visualize/images/SieveDiagram-Example2.PNG)

The **Sieve Diagram** also features the *Score Combinations* option, which makes the ranking of attributes even easier.

![](/widget-catalog/visualize/images/SieveDiagram-Example1.PNG)
