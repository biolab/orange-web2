...
- Time series: Time series from File or as output by [As Timeseries](/widget-catalog/time-series/as_timeseries) widget.
...
![](/widget-catalog/time-series/images/spiralogram.png)
...
We will use [As Timeseries](/widget-catalog/time-series/as_timeseries) for set *Entry creation date* as our time series variable. Then we pass the data to **Spiralogram**. The widget offers many option, so we will show here a slightly more complex set-up.
...
![](/widget-catalog/time-series/images/Spiralogram-Example.png)

#### See also

[Moving Transform](/widget-catalog/time-series/moving_transform_w)
