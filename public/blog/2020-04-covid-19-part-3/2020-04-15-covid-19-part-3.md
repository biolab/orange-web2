...
{{% workflow-screenshot src="2020-04-15-wf1.png" %}}
...
{{% window-screenshot src="2020-04-15-as_timeseries.png" %}}
...
{{% window-screenshot src="2020-04-15-diff-settings.png"%}}
...
{{% window-screenshot src="2020-04-15-quot-settings.png"%}}
...
{{% workflow-screenshot src="2020-04-15-wf3.png"%}}

{{% window-screenshot src="2020-04-15-mt-settings.png"%}}
