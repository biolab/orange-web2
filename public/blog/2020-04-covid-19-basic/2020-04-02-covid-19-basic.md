...
{{% workflow-screenshot src="2020-04-02-workflow-01-01.png" %}}
...
{{% window-screenshot src="2020-04-02-file-widget.png" %}}
...
{{% workflow-screenshot src="2020-04-02-workflow-01-02.png" %}}
...
{{% window-screenshot src="2020-04-02-select-line.gif" %}}
...
{{% workflow-screenshot src="2020-04-02-workflow-01-03.png" %}}
...
{{% window-screenshot src="2020-04-02-steep-curves.png" %}}
...
{{% workflow-screenshot src="2020-04-02-workflow-01-04.png" %}}
...
{{% window-screenshot src="2020-04-02-select-country.png" %}}
...
{{% workflow-screenshot src="2020-04-02-workflow-01-05.png" %}}
...
{{% workflow-screenshot src="2020-04-02-workflow-02-01.png" %}}
To load it, use the Datasets widget, find and double-click the HDI data set.
{{% window-screenshot src="2020-04-02-merge-data.png" %}}
Now we're working with two data sets. 
{{% workflow-screenshot src="2020-04-02-workflow-02-02.png" %}}
...
{{% workflow-screenshot src="2020-04-02-workflow-02-03.png" %}}
...
{{% window-screenshot src="2020-04-02-select-rows.png" %}}

Now for some constructive business. 
{{% workflow-screenshot src="2020-04-02-workflow-02-04.png" %}}
...
{{% workflow-screenshot src="2020-04-02-workflow-02-05.png" %}}
...
{{% window-screenshot src="2020-04-02-select-columns.png" %}}

Finally, add and connect a Data Table.

{{% workflow-screenshot src="2020-04-02-workflow-1-day.png" %}}

Sort by the last column and, voilá, you've ranked countries the number of cases per a million inhabitants.

{{% window-screenshot src="2020-04-02-1-day-table.png" %}}
...
{{% workflow-screenshot src="2020-04-02-workflow-02-07.png" %}}
...
{{% window-screenshot src="2020-04-02-python-script.png" %}} 
