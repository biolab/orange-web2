...
{{% workflow-screenshot src="2020-04-09-workflow-01.png" %}}
...
{{% workflow-screenshot src="2020-04-09-workflow-02.png" %}}
...
{{% window-screenshot src="2020-04-09-file.gif" %}}

To flip rows and columns, we use the Transpose widget. Connect it to the File widget.

{{% workflow-screenshot src="2020-04-09-workflow-03.png" %}}
...
{{% window-screenshot src="2020-04-09-transpose-1.png" %}}
...
{{% workflow-screenshot src="2020-04-09-workflow-04.png" %}}
...
{{% window-screenshot src="2020-04-09-edit-domain.gif" %}}

The data is now ready to be processed by Time Slice. 

{{% workflow-screenshot src="2020-04-09-workflow-05.png" %}}

{{% window-screenshot src="2020-04-09-time-slice.png" %}}
...
{{% workflow-screenshot src="2020-04-09-workflow-06.png" %}}

Under *Future names* select *Generic*, which will name the new column *Feature 1*.

{{% window-screenshot src="2020-04-09-transpose-2.png" %}}
...
{{% workflow-screenshot src="2020-04-09-workflow-07.png" %}}
...
{{% workflow-screenshot src="2020-04-09-workflow-08.png" %}}

Under Conditions, select *Feature 1*, select *is greater than*, and type in *0*.

{{% window-screenshot src="2020-04-09-select-rows.gif" %}}
...
{{% workflow-screenshot src="2020-04-09-workflow-09.png" %}}
